...
class AbstractCaptchaServiceGetClientIpTest {
	...
	@Test
    @Tag("boundary")
    void testGetClientIPWhenXForwardedForHeaderIsNull() {
	...
	@Test
    @Tag("boundary")
    void testGetClientIPWhenXForwardedForHeaderDoesNotContainRemoteAddr() {
	...
	@Test
    @Tag("valid")
    void testGetClientIPWhenXForwardedForHeaderIsValid() {
