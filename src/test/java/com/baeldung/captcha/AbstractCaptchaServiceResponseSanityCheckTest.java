...
public class AbstractCaptchaServiceResponseSanityCheckTest {
	...
	public void testResponseSanityCheckWithEmptyResponse() {
		...
		assertFalse(abstractCaptchaService.responseSanityCheck(emptyResponse));
	}
	...
	public void testResponseSanityCheckWithNullResponse() {
		...
		assertFalse(abstractCaptchaService.responseSanityCheck(nullResponse));
	}
	...
	public void testResponseSanityCheckWithInvalidResponse() {
		...
		assertFalse(abstractCaptchaService.responseSanityCheck(invalidResponse));
	}

	@Test
	@Tag("valid")
	public void testResponseSanityCheckWithValidResponse() {
		String validResponse = "valid_response";
		assertTrue(abstractCaptchaService.responseSanityCheck(validResponse));
	}
