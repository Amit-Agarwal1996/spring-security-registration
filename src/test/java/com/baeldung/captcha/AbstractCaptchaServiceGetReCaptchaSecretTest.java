...
public class AbstractCaptchaServiceGetReCaptchaSecretTest {
	...
	public void testGetReCaptchaSecretReturnValue() {
		...
		assertEquals(expectedSecret, actualSecret, "Expected secret does not match the actual secret");
	}
	...
	public void testGetReCaptchaSecretNullHandling() {
		...
		String secret = abstractCaptchaService.getReCaptchaSecret();
		assertNull(secret, "Secret should be null");
	}
	...
	public void testGetReCaptchaSecretEmptyString() {
		...
		String secret = abstractCaptchaService.getReCaptchaSecret();
		assertEquals("", secret, "Secret should be an empty string");
	}
